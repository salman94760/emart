    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <nav className="bg-white shadow-sm sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          {/* Logo */}
          <div>
            <h1 className="text-3xl font-bold text-black">SSSN</h1>
        ...
        <div className="max-w-7xl mx-auto px-6 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-300 text-lg leading-8 mt-8 max-w-xl">
              Explore the latest collection of lowers, capris, t-shirts, and
              activewear designed for comfort and style.
            </p>
          ...
          {["T-Shirts", "Lowers", "Capris", "Shorts"].map((item) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 mt-2">Premium quality collection</p>
              </div>
            </div>
          ))}
        </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((item) => (
              ...
              >
                ...
                <div className="p-6">
                  <h3 className="text-2xl font-bold">Premium Lower</h3>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              {[1, 2].map((item) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-lg">Stylish T-Shirt</h3>

                    <p className="text-gray-500 mt-1">₹799</p>
                  </div>
          ...
          <div className="bg-white rounded-3xl p-8 shadow-sm">
            ...
            <div className="space-y-5">
              {[1, 2].map((item) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <h3 className="font-bold text-lg">Sports Lower</h3>

                    <p className="text-gray-500 mt-1">₹1299</p>
                  </div>
            ...
            <div className="border-t mt-8 pt-6 flex items-center justify-between">
              ...
              <h3 className="text-3xl font-bold">₹2598</h3>
            </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm">
          ...
          {/* Coupon Section */}
          <div className="mt-8">
            <label className="font-semibold text-lg">Apply Coupon</label>
            ...
            <div className="bg-green-100 text-green-700 rounded-2xl px-5 py-4 mt-4">
              Coupon <span className="font-bold">SAVE20</span> applied
              successfully 🎉
            </div>
          </div>
